...
$('#formrestauracionpuntos').submit(function(){
  ...
  if (result.isConfirmed) {
    ...
    var formData = new FormData(document.getElementById("formrestauracionpuntos"));
    ...
    //alert(textlista);
 	 	$.ajax({
	            type: "POST",
	            url: "../controlador/controllerrestauracionpuntos.php?btnguardar=guardar&txtlistaespecie="+textlista, //esto es el mismo boton guardar del controlador =>($page = isset($_GET['btnguardar'])?$_GET['btnguardar']:'';)
            ...
            success: function(resp) {            
               ...
               if (resp=="-1") {
                ...
                Swal.fire({position: 'top-end',
                  ...
                  title: estado==1?"¡Excelente!,  activada correctamente":"¡Excelente!,  desactivada correctamente",
                  showConfirmButton: false
                });
                consultar("");
              }
