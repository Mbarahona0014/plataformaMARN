...
$y="<script>setInterval(changeNumber(),1000);</script>";
  $tabla="<ul class='sidebar-menu'><li class='header'>OPCIONES:</li>";
  foreach($r as $c){
    //OCULTANDO MENU MANTENIMIENTO MENU CON ID=4
    if($c["idmenu"]!=4){
      ...
      if($c["idmenu"]==6){
        ...
        $tabla.='<li class="treeview">
               ...
               foreach($re as $ce){
                ...
                //SI NO HAY REGISTROS PARA APROBAR NO APARECE LA OPCION EN EL MENU
                if($ce["idsubmenu"]!=22){
