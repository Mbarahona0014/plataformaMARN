...
<script type="text/javascript" src="recursos/js/jsmodelo/jsusuarioexterno.js"></script>
...
<div class="container">
 ...
 <div class="row">
  <div class="col-lg-12">
   ...
   <div class="modal fade bd-example-modal-md" id="modalusuarioexterno"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog modal-md" role="document">
       <div class="modal-content">
        ...
        <div class="modal-body text-center">
          <form id="frmusuarioexterno" name="frmusuarioexterno" enctype="multipart/form-data" method="POST" ><!--Aqui se le pone el ID para obtener todos los datos -->
            ...
            <div class="form-group">
              ...
              <!--input-->
              <select class="form-control form-control-lg text-center" id="tpinstitucion" name="tpinstitucion" style="width: 100%" required>
...
<h3><b>Usuarios externo</b></h3><div id="btnatras"></div>
<div class="row">
  <div class="col-md-12">
    <div class="container" style="background-color: white;">
      <br>

      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalusuarioexterno" data-backdrop="static" data-keyboard="false">
        Ingresar usuario externo&nbsp;&nbsp;<i class="fa fa-hand-pointer-o" aria-hidden="true"></i>
      </button>
      <br><br>
    ...
    <!--OTRO MODAL-->
    <div class="modal fade bd-example-modal-md" id="modalusuarioexterno2"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog modal-md" role="document">
       <div class="modal-content">
         <div class="modal-header">
           <h5 class="modal-title" id="exampleModalLabel">
       ...
       <div class="modal-body text-center">
        <form id="frmusuarioexterno2" enctype="multipart/form-data" name="frmusuario2" method="POST" ><!--Aqui se le pone el ID para obtener todos los datos -->
          <input type="hidden" class="form-control form-control-lg text-center" name="txtid2" id="txtid2" placeholder="txtid2">
            ...
            <div class="form-group">
              ...
              <!--input-->
              <select class="form-control form-control-lg text-center" id="tpinstitucion2" name="tpinstitucion2" style="width: 100%" required>
