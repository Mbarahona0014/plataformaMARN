...
<script type="text/javascript" src="recursos/js/jsmodelo/jsmenu.js"></script>
...
<div class="container">
 ...
 <div class="row">
  <div class="col-lg-12">
   ...
   <div class="modal fade bd-example-modal-md" id="modalmenu"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog modal-md" role="document">
       <div class="modal-content">
        ...
        <div class="modal-body text-center">
          <form id="frmmenu" name="frmmenu" enctype="multipart/form-data" method="POST" ><!--Aqui se le pone el ID para obtener todos los datos -->
            <div class="form-group">
              <label for="txt">
                Ingresar Nombre el menu
              </label>
...
<h3><b>Menu</b></h3><div id="btnatras"></div>
<div class="row">
  <div class="col-md-12">
    <div class="container" style="background-color: white;">
      <br>

      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalmenu" data-backdrop="static" data-keyboard="false">
        Ingresar Menu&nbsp;&nbsp;<i class="fa fa-hand-pointer-o" aria-hidden="true"></i>
      </button>
      <br><br>
    ...
    <!--OTRO MODAL-->
    <div class="modal fade bd-example-modal-md" id="modalmenu2"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog modal-md" role="document">
       <div class="modal-content">
         <div class="modal-header">
           <h5 class="modal-title" id="exampleModalLabel">
       ...
       <div class="modal-body text-center">
        <form id="frmmenu2" enctype="multipart/form-data" name="frmmenu2" method="POST" ><!--Aqui se le pone el ID para obtener todos los datos -->
          <input type="hidden" class="form-control form-control-lg text-center" name="txtidmenu2" id="txtidmenu2" placeholder="txtid2">
          <div class="form-group">
              <label for="txt">
                Ingresar Nombre el menu
              </label>
