...
<script type="text/javascript" src="recursos/js/jsmodelo/jsaprobacionrestauracion.js"></script>
...
<div class="container-fluid">
      ...
      <h3><b>Aprobación de registro restauración</b></h3>
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">
                                        Modificar punto de restauración
                 </h5>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="hidden" class="form-control form-control-lg text-center" name="txtlongitud2" id="txtlongitud2" placeholder="Longitud">
                </div>
                <div class="form-group col-md-6">
                    <!-- <label for="txtlatitud2">
                              Latitud
                  </label> -->
                    <input type="hidden" class="form-control form-control-lg text-center" name="txtlatitud2" id="txtlatitud2" placeholder="Latitud">
                </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="number" class="form-control form-control-lg text-center" id="txtcantidadpersonas2" name="txtcantidadpersonas2" placeholder="Cantidad de personas" min="0" pattern="^[0-9]+" required>
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  <!--input-->
                    <input type="text" class="form-control form-control-lg text-center" name="txtcanton2" id="txtcanton2" placeholder="Cantón">
                </div>
                <div class="form-group col-md-6">
                  ...
                  <!--input-->
                    <input type="text" class="form-control form-control-lg text-center" name="txtubicacion2" id="txtubicacion2" placeholder="Ubicación">
                </div>
                <div class="form-group col-md-6">
                  ...
                  <!--input-->
                    <input type="text" class="form-control form-control-lg text-center" name="txtbeneficiarios2" id="txtbeneficiarios2" placeholder="Ubicación">
                </div>
                <div class="form-group col-md-12">
                  ...
                  <!--input-->
                    <input type="text" class="form-control form-control-lg text-center" name="txtinstituciones2" id="txtinstituciones2" placeholder="Instituciones">
                </div>
                <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="txtarea2">Hectáreas</label>
                    <input type="number" class="form-control form-control-lg text-center" id="txtarea2" name="txtarea2" placeholder="Ingrese cantidad de hectáreas" step="0.1" required>
                </div>
              </div>
                <div class="form-row">
                  <div class="form-group col-md-12">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      ...
                      <textarea class="form-control" id="txtcomentarios2" name="txtcomentarios2" placeholder="Comentarios" oninput="this.value=this.value.replace(/\n/g,'')"></textarea>
                    </div>
                  </div>
